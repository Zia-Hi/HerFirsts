...
export function MissionCompletedScene() {
  ...
  const { unlockShowerCard, openNotebook, closeNotebook } = useKnowledgeStore();
  ...
  }, [unlockShowerCard, openNotebook, play]);
    ...
    <div className="relative h-full w-full overflow-hidden bg-black">
      <AnimatePresence>
        {showImage && (
          ...
          >
            <Image
              src="/images/shower/mission_1_completed.jpg"
