...
export function HotelOpeningScene() {
  const [phase, setPhase] = useState<"black" | "subtitle" | "city-view" | "brightening" | "hotel-reveal" | "complete">("black");
  ...
  const runSequence = useCallback(async () => {
    setGamePhase("hotel-opening");

    setPhase("black");
    await wait(1500);

    setPhase("subtitle");
    setSubtitle("Six months later.");
    await wait(500);
    await wait(1000);
    await wait(2000);
    setSubtitle(null);
    ...
    setSubtitle("Your first business trip.");
    await wait(2000);
    setSubtitle("New adventures await.");
    await wait(2500);
  ...
  const handleStart = useCallback(async () => {
    ...
    setGamePhase("hotel");
    setCurrentScene(SCENE_IDS.HOTEL);
          ...
          >
            ...
            >
              <div className="relative h-full w-full">
                <img
                  src="/pinterest/hotel/landing.png"
                  alt="Hotel city view"
